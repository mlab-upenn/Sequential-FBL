function [ rho_goal ] = robustness_goal_seq(xx,yy,zz,d,g,I,optParams)
...
% eventually goal in x y z
    rho_lb_xx = xx(I,1)-optParams.goal{g}.goal_lb_N(I,1);
    rho_ub_xx = optParams.goal{g}.goal_ub_N(I,1)-xx(I,1);
    rho_lb_yy = yy(I,1)-optParams.goal{g}.goal_lb_N(I,2);
    rho_ub_yy = optParams.goal{g}.goal_ub_N(I,2)-yy(I,1);
    rho_lb_zz = zz(I,1)-optParams.goal{g}.goal_lb_N(I,3);
    rho_ub_zz = optParams.goal{g}.goal_ub_N(I,3)-zz(I,1);
