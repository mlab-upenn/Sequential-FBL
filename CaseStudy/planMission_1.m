function [w_opt, optParams, time_taken] = planMission_1(missionHandle)
import casadi.*
...
% low frequency point between waypoint
...
% Total Number of steps (per Drone) Tf=T/h
...
prob = struct('f', Mission_Robustness_1(var,optParams), 'x', var, 'g', g);
...
var0 = [w0;vv0];
optParams.var0 = var0;
Init_waypoints_rob = Mission_Robustness_1(var0,optParams);
toc
%% solve the nlp
disp('Solving...');
tic;
